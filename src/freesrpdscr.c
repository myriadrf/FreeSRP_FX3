...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    /* Endpoint descriptor for UART_IN consumer */
    0x07,                           /* Descriptor size */
    CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	FREESRP_USB_ENDPOINT_CMD_IN,    /* Endpoint address and description */
    CY_U3P_USB_EP_INTR,             /* Interrupt endpoint type */
    0x40,0x00,                      /* Max packet size = 64 bytes */
    0x02,                           /* Servicing interval for data transfers */

    /* Super speed endpoint companion descriptor for UART_IN consumer EP */
    0x06,                           /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
    0x00,                           /* Max no. of packets in a burst: 0: burst 1 packet at a time */
    0x00,                           /* Max streams for bulk EP = 0 (No streams) */
    0x40,0x00,                      /* Total number of bytes per service interval = 64 bytes. */

    /* Endpoint descriptor for UART_OUT producer */
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	FREESRP_USB_ENDPOINT_CMD_OUT,   /* Endpoint address and description */
	CY_U3P_USB_EP_INTR,             /* Interrupt endpoint type */
	0x40,0x00,                      /* Max packet size = 64 bytes */
	0x02,                           /* Servicing interval for data transfers */

	/* Super speed endpoint companion descriptor for UART_OUT producer EP */
	0x06,                           /* Descriptor size */
	CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
	0x00,                           /* Max no. of packets in a burst: 0: burst 1 packet at a time */
	0x00,                           /* Max streams for bulk EP = 0 (No streams) */
	...
	/* Endpoint descriptor for RX_DATA_IN consumer */
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	FREESRP_USB_ENDPOINT_RX_DATA_IN,/* Endpoint address and description */
	CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
	0x00,0x04,                      /* Max packet size = 1024 bytes */
	0x00,                           /* Servicing interval for data transfers: 0 for bulk */

	/* Super speed endpoint companion descriptor for RX_DATA_IN consumer EP */
	0x06,                           /* Descriptor size */
	CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
	0x00,                           /* Max no. of packets in a burst: 0: burst 1 packet at a time */
	0x00,                           /* Max streams for bulk EP = 0 (No streams) */
	...
	/* Endpoint descriptor for TX_DATA_OUT producer */
	0x07,                           /* Descriptor size */
	CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
	FREESRP_USB_ENDPOINT_TX_DATA_OUT,/* Endpoint address and description */
	CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
	0x00,0x04,                      /* Max packet size = 1024 bytes */
	0x00,                           /* Servicing interval for data transfers: 0 for bulk */

	/* Super speed endpoint companion descriptor for TX_DATA_OUT producer EP */
	0x06,                           /* Descriptor size */
	CY_U3P_SS_EP_COMPN_DESCR,       /* SS endpoint companion descriptor type */
	0x00,                           /* Max no. of packets in a burst: 0: burst 1 packet at a time */
	0x00,                           /* Max streams for bulk EP = 0 (No streams) */
