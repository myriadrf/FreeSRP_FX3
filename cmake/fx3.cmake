# (with some modifications by Lukas Lao Beyer)
...
set(FX3BASEROOT ${FX3_INSTALL_PATH}/fw_build/fx3_fw)
...
# -Map $(MODULE).map
if ("${FX3_LD_SCRIPT}" STREQUAL "")
    set(FX3_LD_SCRIPT
        ${FX3BASEROOT}/fx3cpp.ld
    )
endif()

set(CMAKE_EXE_LINKER_FLAGS
  "-T \"${FX3_LD_SCRIPT}\" -d --gc-sections --no-wchar-size-warning -nostdlib -nostartfiles --entry CyU3PFirmwareEntry")
...
if ("${FX3_CORE_ASM_SRC}" STREQUAL "")
    set(FX3_CORE_ASM_SRC
        ${FX3BASEROOT}/cyfx_gcc_startup.S
    )
endif()

if ("${FX3_CORE_C_SRC}" STREQUAL "")
    set(FX3_CORE_C_SRC
        ${FX3BASEROOT}/cyfxtx.c
    )
endif()

if ("${FX3_CORE_CXX_SRC}" STREQUAL "")
    set(FX3_CORE_CXX_SRC
        ${FX3BASEROOT}/cyfxtx.cpp
        ${FX3BASEROOT}/cyfxcppsyscall.cpp
    )
endif()
